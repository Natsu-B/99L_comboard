...
use crate::{
    ...
    state::{
        ...
        CAN_RX_SUCCESS_COUNT, CAN_SAFETY_TX_CHANNEL, CAN_TEC, CAN_TX_CHANNEL, CAN_TX_ERROR_COUNT,
        CAN_TX_SUCCESS_COUNT, COMMAND_RESULT_LORA_CHANNEL, COMMAND_TRACKER,
        CONTROL_ROLL_LORA_SIGNAL, EMERGENCY_RESULT_LORA_CHANNEL, GNSS_CMD_CHANNEL,
        GROUND_TIME_REQUEST_LORA_CHANNEL, GnssCommand, IS_CAN_ERROR, LOGGING_REQUESTED,
